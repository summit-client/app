-- 0053 · Merging two parallel builds of the same portal
--
...
comment on table client_messages is
  ...
  'replaced in 0053. Rows were carried forward; the write policies are gone, '
...
-- that 0050's staff policies were written against: a scheduler who may look at
...
-- ---------------------------------------------------------------------------
-- 6. Re-run the view sweep from 0052
--
