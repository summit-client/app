...
export const SETTINGS: SettingDef[] = [
  ...
  { key: "clients.staleAfterDays", label: "Flag active clients as stale after (days)", description: "Drives the scheduler's \"needs attention\" engagement leaderboard - an active client with no session (past or upcoming, excluding cancelled) within this many days is flagged. \"Last session\" is the most recent session_date regardless of whether it's in the past or future, since nothing in this app ever marks a session completed - see the leaderboard's own code comment. Clinics differ on what counts as too long; this makes it configurable rather than a hardcoded constant.", section: "calendar", scope: "org", type: "number", default: 14, keywords: ["waitlist", "engagement", "stale", "leaderboard", "needs attention"] },
