...
const nextConfig = {
  ...
  transpilePackages: ["@summit/design", "@summit/analytics", "@summit/clinical-ai", "@summit/settings", "@summit/nav", "@summit/portals", "@summit/session", "@summit/proxy-auth", "@summit/toast"],
};
