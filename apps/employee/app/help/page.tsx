  ...
  return (
    <div>
      ...
      <p className="sub" style={{ maxWidth: "64ch" }}>
        ...
        that looks wrong — a task that should not apply to you, a missing certificate, a balance that seems off —
      ...
      <div className="card card-pad" style={{ marginTop: 16 }}>
        ...
        <ul style={{ margin: "10px 0 0", paddingLeft: 18, display: "flex", flexDirection: "column", gap: 8, fontSize: "var(--text-sm)", color: "var(--muted)" }}>
          ...
          <li>Tasks marked <i>Supervisor sign-off</i> move to &ldquo;Ready for sign-off&rdquo; when you finish them — your supervisor completes them from the Admin page.</li>
